...
/** 默认参数 */
// export const copyright = `<span class="version" style="color: #ffb6c1;"> Karin v${config.pkg().version} </span> & <span class="version" style="color:rgba(147, 172, 247, 0.71);"> ${Root.pluginName} v${pkg().version} </span>`
/**
 * 渲染
